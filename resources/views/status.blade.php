      ...
      <div class="modal-body">
          <div class="row">
              ...
              <div class="col col-md-6">
                  ...
                  <input type="text" name='descricao' class='form-control' required autocomplete="off" maxlength="20">
              </div>
              <div class="col col-md-6">
                  <label>Cor</label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="row">
              ...
              <div class="col col-md-6">
                  <label>Descrição</label>
                   <input type="text" id='item-descricao' name='descricao' class='form-control' required autocomplete="off" maxlength="20">
              </div>
              <div class="col col-md-6">
                  <label>Cor</label>
